  ...
  return (
    <nav className="bg-gray-800 p-4 shadow-md">
      ...
      <ul className="flex space-x-6">
        ...
        <li>
          <Link href="/request-callback" className={`text-gray-300 hover:text-white transition duration-200 ${activeLink === 'request-callback' ? 'text-white' : ''}`} onClick={() => handleLinkClick('request-callback')}>Request Callback</Link>
        </li>
